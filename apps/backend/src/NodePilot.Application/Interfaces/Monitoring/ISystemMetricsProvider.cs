...
public interface ISystemMetricsProvider
{
    ...
    public Task<ErrorOr<IReadOnlyList<IntervalMetricsSummary>>> GetHistoricalMetricsAsync(DateTime start, DateTime end, int? minIntervalSeconds, CancellationToken ct = default);
}
